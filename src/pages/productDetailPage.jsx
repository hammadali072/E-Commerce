    ...
    if (!product) {
        return (
            <div className="flex flex-col items-center justify-center gap-6 bg-white text-center px-4">
                <h1 className="text-6xl font-semibold text-dark/10">404</h1>
                <p className="text-xl font-semibold text-dark">Product Not Found</p>
                <p className="text-dark/40 text-sm max-w-xs">The product you're looking for doesn't exist or has been removed.</p>
                <button
                    onClick={() => navigate('/shop')}
                    className="mt-4 h-12 px-10 bg-dark text-white text-xs font-semibold uppercase tracking-widest hover:bg-amber hover:text-dark duration-300"
                >
                    Back to Shop
                </button>
            </div>
        ...
        <>
            ...
            <section className="py-10 sm:py-16 md:py-24">
                <div className="container">
                    <button
                        onClick={() => navigate(-1)}
                        className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-dark/40 mb-8 md:mb-12 duration-300 hover:text-amber"
                    >
